...
6. [HPO Body Map メンテナンス手順](./06-hpo-body-map-maintenance.md)
7. [My Disease 機能仕様](./07-my-diseases-feature.md)
8. [将来構想: Connected Rare Disease Platform](./08-future-vision-connected-rare-disease-platform.md)
9. [キャラクターデザイン方針](./09-character-design-guidelines.md)
10. [ステゴサウルス ベース種メモ](./10-stegosaurus-base-notes.md)
11. [マスコットデザイン方針](./11-mascot-design-direction.md)
12. [ホスファテゴサウルス キャラ設定書](./12-phosphategosaurus-character-brief.md)
13. [ホスファテゴサウルス ラフ指示書](./13-phosphategosaurus-art-prompt.md)
14. [ホスファテゴサウルス 短縮プロンプト集](./14-phosphategosaurus-short-prompts.md)
15. [骨・関節系疾患カテゴリ 5ベース設計メモ](./15-bone-joint-five-base-plan.md)
16. [骨・関節系疾患カテゴリ 5ベース ラフ指示書](./16-bone-joint-five-base-art-prompts.md)
17. [骨・関節系疾患カテゴリ 5ベース確定版](./17-bone-joint-five-base-approved.md)
18. [疾患キャラクター自動化アーキテクチャ](./18-character-generation-automation.md)
...
- マスコット寄りの絵柄方針を確認したいとき: `11-mascot-design-direction.md`
- ホスファテゴサウルスの設定を確認したいとき: `12-phosphategosaurus-character-brief.md`
- 画像生成やイラスト依頼に渡す文面が欲しいとき: `13-phosphategosaurus-art-prompt.md`
- 画像生成ツール向けの短い入力文が欲しいとき: `14-phosphategosaurus-short-prompts.md`
- 骨・関節系疾患カテゴリの5ベース運用を確認したいとき: `15-bone-joint-five-base-plan.md`
